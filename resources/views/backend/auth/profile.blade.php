            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.update.profile') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img class="rounded avatar-lg"
                                     src="{{ (!empty($user->image))? url('assets/backend/images/users/'.$user->image): url('backend/uploads/default.jpg') }}"
                                     alt=""
                                     id="imageShow">
                            </div>
                        </div>
                        ...
                        <label for="example-text-input" class="col-sm-2"></label>
                        <a href="{{ route('admin.dashboard') }}" class="btn btn-danger">Geri</a>
