                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control"
                                                              ...
                                                              id="editor"
                                                              cols="30"
                                                              rows="10">{!! $services->description_ar !!}</textarea>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-select" aria-label="Default select example" name="status">
                                                        ...
                                                        <option value="Inactive" {{ $services == 'Inactive' ? 'selected' : ""}}>In Aktiv</option>
                                                        <option value="Active" {{ $services == 'Active' ? 'selected' : '' }}>Aktiv</option>
                                                    </select>
                                                    @error('status')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
