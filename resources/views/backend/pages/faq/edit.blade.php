                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control"
                                                              ...
                                                              id="editor"
                                                              cols="30"
                                                              rows="10">{!! $faq->answer_ar !!}</textarea>
                                                    @error('answer_ar')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-select" aria-label="Default select example" name="status">
                                                        ...
                                                        <option value="Inactive" {{ $faq->status == 'Inactive' ? 'selected' : '' }}>In Aktiv</option>
                                                        <option value="Active" {{ $faq->status == 'Active' ? 'selected' : ''}}>Aktiv</option>
                                                    </select>
                                                    @error('status')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control"
                                                              ...
                                                              id="editor_en"
                                                              cols="30"
                                                              rows="10">{!! $faq->answer_en !!}</textarea>
                                                    @error('answer_en')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control"
                                                              ...
                                                              id="editor_ru"
                                                              cols="30"
                                                              rows="10">{!! $faq->answer_ru !!}</textarea>
                                                    @error('answer_ar')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
