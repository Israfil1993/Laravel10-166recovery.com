                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control"
                                                              ...
                                                              id="editor"
                                                              cols="30"
                                                              rows="10">{!! $blog->description_ar !!}</textarea>
                                            ...
                                            <div class="row mb-3">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Published</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control"
                                                           type="date"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-select" aria-label="Default select example" name="status">
                                                        ...
                                                        <option value="Inactive" {{ $blog->status == 'Inactive' ? 'selected' : ''}}>In Aktiv</option>
                                                        <option value="Active" {{ $blog->status == 'Active' ? 'selected' : '' }}>Aktiv</option>
                                                    </select>
                                                    @error('status')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control"
                                                              ...
                                                              id="editor_en"
                                                              cols="30"
                                                              rows="10">{!! $blog->description_en !!}</textarea>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control"
                                                              ...
                                                              id="editor_ru"
                                                              cols="30"
                                                              rows="10">{!! $blog->description_ru !!}</textarea>
